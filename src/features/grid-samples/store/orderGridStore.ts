...
const initialState: OrderGridState = {
  pagination: {
    page: 1,
    pageSize: 20,
    total: 0,
...
export const useOrderGridStore = create<OrderGridState & OrderGridActions>()(
  devtools(
    (set, get) => ({
      ...initialState,
...
export const useOrderGridPagination = () =>
  useOrderGridStore((state) => state.pagination);

export const useOrderGridSorts = () =>
  useOrderGridStore((state) => state.sorts);

export const useOrderGridFilters = () =>
  useOrderGridStore((state) => state.filters);

export const useOrderGridSelection = () =>
  useOrderGridStore((state) => ({
